...
public class Shake_for_passwd_notes extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shake_for_passwd_notes);
        ...
        tv_count= (TextView) findViewById(R.id.shake_count);
        tv_need_count= (TextView) findViewById(R.id.shake_need_count);
        btn_help= (Button) findViewById(R.id.shake_help);
...
//        System.out.println("得到的密码是"+passwd);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_shake_for_passwd_notes, menu);
        return true;
    }
